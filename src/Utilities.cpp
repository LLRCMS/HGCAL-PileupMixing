...
/*****************************************************************/
void PileupMixing::tokenize(const string& str,
        vector<string>& tokens,
...
/*****************************************************************/
string PileupMixing::intToString(int n)
/*****************************************************************/
{
    ostringstream oss;
    oss << n;
...
/*****************************************************************/
void PileupMixing::findAndReplace(string& sInput, string sFind, string sReplace )
/*****************************************************************/
{
    size_t itPos = 0; 
...
/*****************************************************************/
void PileupMixing::strip(std::string& sInput)
/*****************************************************************/
{
